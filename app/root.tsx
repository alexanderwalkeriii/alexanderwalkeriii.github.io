  ...
  return (
    <html lang="en">
      <head>
        ...
        <Meta />
        <Links />
        {/* Restore path encoded by 404.html before React Router initializes */}
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){var p=new URLSearchParams(location.search).get('p');if(p){history.replaceState(null,'',p);}})()`,
          }}
        />
      </head>
      <body>
